...
/*Data for the table `billing_resource` */

insert  into `billing_resource`(`resource_id`,`resource_name`,`billing_item`,`region_id`,`sum`,`parent_id`,`status`,`account_id`,`created_at`,`updated_at`,`deleted_at`,`resource_type`) values ('25','test1','instance_1','region1',1,NULL,'starting','sfdsfd','2015-09-02 18:16:29',NULL,NULL,'instance');
...
/*Data for the table `using` */

insert  into `using`(`using_id`,`resource_id`,`created_at`,`started_at`,`ended_st`,`tran_status`) values ('1','25','2015-08-26 04:06:41','2015-08-26 04:00:00','2015-08-26 04:59:59',NULL);
